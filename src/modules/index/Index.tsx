...
export type IndexProps = IndexState & IndexDispatch & RouteComponentProps<undefined>;

export const Index: React.StatelessComponent<IndexProps> = ({ title, todos, loading, setTitle, saveTodo, setDone }) =>
...
export default connect<IndexState, IndexDispatch, IndexProps, State>((state): IndexState => ({
